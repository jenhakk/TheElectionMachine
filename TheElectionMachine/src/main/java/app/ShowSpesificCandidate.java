...
public class ShowSpesificCandidate extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// if I understand right, this gets the parametre "id" from the browsecandidates.jsp-file
		String id=request.getParameter("id");
		//this prints the id-number of selected candidate:
		System.out.println(id);
		
		// Object candidate for empty
		Candidate candi = null;
		
		// if we get connection, then readCandi-method, set id for a parametre to get this candidates info
